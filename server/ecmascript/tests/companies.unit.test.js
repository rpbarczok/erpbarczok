...
describe('Company Tests', function () {
    ...
    describe('Test getCompanyById(id)', function () {
        it('getCompanyById(1) returns {"id": 1, "name": "Firma C", "abbr": "FRC", www: "www.firmaa.com"}', async () => {
            await expect(getCompanyById(1)).resolves.toEqual(expect.any(Company) && expect.objectContaining({ "id": 1, "name": "Firma A", "abbr": "FRA", "www": "www.firmaa.com", CompanytypeId: null, createdAt: expect.any(Date), updatedAt: expect.any(Date) }));
        });
        it('getCompanyById(2) returns {"id": 2, "name": "Firma B", "abbr": null, www: null }', async () => {
            await expect(getCompanyById(2)).resolves.toEqual(expect.any(Company) && expect.objectContaining({ "id": 2, "name": "Firma B", "abbr": null, "www": null, CompanytypeId: null, createdAt: expect.any(Date), updatedAt: expect.any(Date) }));
        });
    ...
    describe('Test getCompanyById(id)', function () {
        it('putCompanyById(1) change name to "Firma C"', async () => {
            await expect(putCompanyById(1, { "name": "Firma C", "abbr": "FRA" })).resolves.toBeUndefined();
        });
        it('getCompanyById(1) returns {"id": 1, "name": "Firma C", "abbr": "FRA", "www": null} after Name Change', async () => {
            await expect(getCompanyById(1)).resolves.toEqual(expect.any(Company) && expect.objectContaining({ "id": 1, "name": "Firma C", "abbr": "FRA", "www": null, CompanytypeId: null, createdAt: expect.any(Date), updatedAt: expect.any(Date) }));
        });
        it('putCompanyById(1) adds www', async () => {
            await expect(putCompanyById(1, { "name": "Firma C", "abbr": "FRA", "www": "www.example.de" })).resolves.toBeUndefined();
        });
        it('getCompanyById(1) returns {"id": 1, "name": "Firma C", "abbr": "FRA", "www": "www.example.de"} after www addition', async () => {
            await expect(getCompanyById(1)).resolves.toEqual(expect.any(Company) && expect.objectContaining({ "id": 1, "name": "Firma C", "abbr": "FRA", "www": "www.example.de", CompanytypeId: null, createdAt: expect.any(Date), updatedAt: expect.any(Date) }));
        });
        ...
        it('putCompanyById(1) remove abbr', async () => {
            await expect(putCompanyById(1, { "name": "Firma C" })).resolves.toBeUndefined();
        });
        it('getCompanyById(1) returns {"id": 1, "name": "Firma C", "abbr": null, "www": null} after abbr removal', async () => {
            await expect(getCompanyById(1)).resolves.toEqual(expect.any(Company) && expect.objectContaining({ "id": 1, "name": "Firma C", "abbr": null, "www": null, CompanytypeId: null, createdAt: expect.any(Date), updatedAt: expect.any(Date) }));
        });
        it('putCompanyById(1) add abbr', async () => {
            await expect(putCompanyById(1, { "name": "Firma C", "abbr": "FRC" })).resolves.toBeUndefined();
        });
        it('getCompanyById(1) returns {"id": 1, "name": "Firma C", "abbr": "FRC"} after abbr addition', async () => {
            await expect(getCompanyById(1)).resolves.toEqual(expect.any(Company) && expect.objectContaining({ "id": 1, "name": "Firma C", "abbr": "FRC", "www": null, CompanytypeId: null, createdAt: expect.any(Date), updatedAt: expect.any(Date) }));
        });
        it('putCompanyById(1) remove name returns error', async () => {
            // @ts-ignore:next-line
            await expect(putCompanyById(1, { "abbr": "FRC" })).resolves.toBeUndefined();
        });
    ...
    describe('Test DeleteCompanyById', function () {
        ...
        it('getAllCompanies returns only 2', async () => {
            await expect(getAllCompanies()).resolves.toEqual([expect.any(Company) && expect.objectContaining({ "id": 2, "name": "Firma B", "abbr": null, "www": null, CompanytypeId: null, createdAt: expect.any(Date), updatedAt: expect.any(Date) })
            ]);
        });
    });
});
