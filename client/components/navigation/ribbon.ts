...
const formArray: Form[] = [
    ...
    { name: "Anfragen", id: "anfragenForm", group: "pro", scopes: "public user admin", order: 2 },
    ...
    { name: "Angebote", id: "angForm", group: "art", scopes: "public user admin", order: 1 },
    { name: "Prüfmittel", id: "prüfForm", group: "art", scopes: "public user admin", order: 4 },
    { name: "Aufträge", id: "aufForm", group: "auf", scopes: "public user admin", order: 0 },
    { name: "AB", id: "abForm", group: "auf", scopes: "public user admin", order: 1 },
    { name: "Bestellung Lieferant", id: "bestLiefForm", group: "auf", scopes: "public user admin", order: 2 },
    ...
    { name: "Speditions-Rechnung", id: "spedRechForm", group: "sped", scopes: "public user admin", order: 1 },
    { name: "Waren-ER", id: "warenForm", group: "sped", scopes: "public user admin", order: 2 },
    { name: "Zwischen-Lager", id: "lagerForm", group: "lag", scopes: "public user admin", order: 0 },
    { name: "Sicherheitslager", id: "silaForm", group: "lag", scopes: "public user admin", order: 1 },
    { name: "Auslieferung SiLa", id: "ausliefForm", group: "lag", scopes: "public user admin", order: 2 },
    ...
    { name: "Muster", id: "musterForm", group: "pro", scopes: "public user admin", order: 3 },
    { name: "Monster", id: "monsterForm", group: "sonst", scopes: "public user admin", order: 0 },
    { name: "Rechnung", id: "rechForm", group: "rech", scopes: "public user admin", order: 0 },
    { name: "Gebühren", id: "gebForm", group: "rech", scopes: "public user admin", order: 1 },
