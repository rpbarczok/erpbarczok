...
export const companyTypeDescription: ResourceDescription<CompanyType> = { name: 'Beziehung', paths: { 'all': '/company-types/', 'single': '/company-types/{id}' }, empty: { meta: { location: 0, etag: '' }, data: { name: '' } } }
